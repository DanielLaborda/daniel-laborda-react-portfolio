...
export default class PortfolioForm extends Component {
        ...
        if (Object.keys(this.props.portfolioToEdit).length > 0) {
          ...
          this.props.clearPortfolioToEdit();
            ...
            this.setState ({
                ...
                url: url || "",
                editMode: true,
                apiUrl: `https://daniellaborda.devcamp.space/portfolio/portfolio_items/${id}`,
                apiAction: "patch",
    ...
    handleSubmit(event){
        if(this.state.editMode){
            axios.patch(`${this.state.apiUrl}`, this.buildForm(), {withCredentials: true
            }).then(response => {
    ...
    render() {
        return (
            <form onSubmit={this.handleSubmit} className="portfolio-form-wrapper">
                ...
                <div className="two-column">
                    <input type="text" name="position" placeholder="Portfolio Item Position" value={this.state.position} onChange={this.handleChange}/>
                    <select 
                        name="category" 
                ...
                <div className="one-column">
                    <textarea type="text" name="description" placeholder="Portfolio Item description" value={this.state.description} onChange={this.handleChange}/>
                </div>
