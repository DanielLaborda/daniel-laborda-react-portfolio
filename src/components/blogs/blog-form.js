...
export default class BlogForm extends Component {
  constructor(props) {
    ...
    this.featureImageRef = React.createRef();
  ...
  componentWillMount(){
    if (this.props.editMode) {
      this.setState({
        ...
        apiUrl: `https://daniellaborda.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
        apiAction: "patch"
      });
    }
  }
  ...
  handleSubmit(event) {
    axios({
      ...
      withCredentials: true
        ...
        if(this.state.featured_image){
          this.featureImageRef.current.dropzone.removeAllFiles();
        }
        this.setState({
            title: "",
            blog_status: "",
