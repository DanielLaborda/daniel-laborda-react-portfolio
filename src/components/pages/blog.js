...
export default class Blog extends Component {
  ...
  onScroll() {
    if (this.isLoading || this.state.blogItems.length === this.state.totalCount){
      return;
    }
  ...
  getBlogItems(){
    ...
    axios.get(`https://daniellaborda.devcamp.space/portfolio/portfolio_blogs?page=${this.state.currentPage}`, {withCredentials: true})
    .then(response => {
